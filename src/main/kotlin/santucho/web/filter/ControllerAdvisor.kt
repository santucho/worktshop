...
class ControllerAdvisor @Inject constructor(
    ...
    private fun apiExceptionHandler(apiException: ApiException, req: Request, res: Response) {
        noticeError(apiException)
        val apiError = apiException.toApiError()
    ...
    init {
        ...
        exception(ApiException::class.java, this::apiExceptionHandler)
